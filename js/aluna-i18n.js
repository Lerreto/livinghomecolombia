...
(function () {
  ...
  var T = {
    ...
    "off.c4.2": { en:"Palmira, calm, close to the airport and with low costs", es:"Palmira, tranquila, cerca del aeropuerto y con costos bajos", de:"Palmira, ruhig, am Flughafen und mit niedrigen Kosten", fr:"Palmira, calme, près de l'aéroport et avec des coûts faibles" },
    ...
    "off.c4.4": { en:"Calima El Darién, lake, kitesurf and adventure", es:"Calima El Darién, lago, kitesurf y aventura", de:"Calima El Darién, See, Kitesurf und Abenteuer", fr:"Calima El Darién, lac, kitesurf et aventure" },
    ...
    "gin.a5.p": { en:"A city of 2.2 million, with hospitals, universities, international dining and an international airport, sits under an hour away. You keep the peace of the countryside without giving up a thing.", es:"Una ciudad de 2,2 millones, con hospitales, universidades, gastronomía internacional y un aeropuerto internacional, está a menos de una hora. Conservas la paz del campo sin renunciar a nada.", de:"Eine Stadt mit 2,2 Millionen Einwohnern, mit Krankenhäusern, Universitäten, internationaler Gastronomie und einem internationalen Flughafen, liegt weniger als eine Stunde entfernt. Sie bewahren die Ruhe des Landes, ohne auf irgendetwas zu verzichten.", fr:"Une ville de 2,2 millions d'habitants, avec hôpitaux, universités, gastronomie internationale et un aéroport international, se trouve à moins d'une heure. Vous gardez le calme de la campagne sans renoncer à rien." },
    ...
    "prop.desc": { en:"A century-old country home in good condition, tastefully remodeled, with six bedrooms, generous living spaces and three shaded corridors, set among pastures, green zones and fruit trees. River and municipal Acuavalle water, at 1,136 m where the air stays near 24°C all year.", es:"Una casa campestre centenaria en buen estado, remodelada con buen gusto, con seis alcobas, amplios espacios sociales y tres corredores con sombra, entre potreros, zonas verdes y árboles frutales. Aguas de río y de la red Acuavalle, a 1.136 m donde el aire se mantiene cerca de 24°C todo el año.", de:"Ein hundertjähriges Landhaus in gutem Zustand, geschmackvoll renoviert, mit sechs Schlafzimmern, großzügige Wohnbereiche und drei schattige Korridore, umgeben von Weiden, Grünflächen und Obstbäumen. Fluss- und kommunales Acuavalle-Wasser, auf 1.136 m, wo die Luft das ganze Jahr nahe 24°C bleibt.", fr:"Une maison de campagne centenaire en bon état, rénovée avec goût, avec six chambres, de vastes espaces de vie et trois corridors ombragés, au milieu de pâturages, d'espaces verts et d'arbres fruitiers. Eau de rivière et du réseau Acuavalle, à 1 136 m où l'air reste proche de 24°C toute l'année." },
    ...
    "faq.a3": { en:"A comfortable monthly lifestyle, including food, utilities, transport, healthcare and leisure, typically runs $1,500–2,000 USD per month here, several times less than a comparable life in Florida or Germany.", es:"Un estilo de vida mensual cómodo, incluyendo comida, servicios, transporte, salud y ocio, suele costar $1.500–2.000 USD al mes aquí, varias veces menos que una vida comparable en Florida o Alemania.", de:"Ein komfortabler monatlicher Lebensstil, einschließlich Essen, Nebenkosten, Transport, Gesundheit und Freizeit, kostet hier in der Regel 1.500–2.000 USD pro Monat, ein Mehrfaches weniger als ein vergleichbares Leben in Florida oder Deutschland.", fr:"Un mode de vie mensuel confortable, incluant nourriture, charges, transport, santé et loisirs, coûte généralement 1 500–2 000 USD par mois ici, plusieurs fois moins qu'une vie comparable en Floride ou en Allemagne." },
    ...
    "form.s2.hint": { en:"Tell us how you'd prefer to be contacted, and we'll only use it to send the guide and arrange your call.", es:"Dinos cómo prefieres que te contactemos, y solo lo usaremos para enviar la guía y coordinar tu llamada.", de:"Sagen Sie uns, wie Sie kontaktiert werden möchten, und wir nutzen es nur, um den Leitfaden zu senden und Ihren Anruf zu vereinbaren.", fr:"Dites-nous comment vous préférez être contacté, et nous l'utiliserons uniquement pour envoyer le guide et organiser votre appel." },
