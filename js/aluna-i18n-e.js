...
(function () {
  ...
  var T = {
    ...
    "hero.foot":   { en:"Aluna Luxe — where vision becomes home", es:"Aluna Luxe — donde la visión se hace hogar", de:"Aluna Luxe — wo Vision Zuhause wird", fr:"Aluna Luxe — où la vision devient foyer" },
    "hero.scroll": { en:"Scroll", es:"Explora", de:"Scrollen", fr:"Défiler" },

    /* MANIFESTO */
    "man.1": { en:'In the language of the Sierra Nevada, <em>Aluna</em> is the origin of all things — where everything exists before it takes form.',
               es:'En la lengua de la Sierra Nevada, <em>Aluna</em> es el origen de todas las cosas — donde todo existe antes de tomar forma.',
               de:'In der Sprache der Sierra Nevada ist <em>Aluna</em> der Ursprung aller Dinge — wo alles existiert, bevor es Gestalt annimmt.',
               fr:'Dans la langue de la Sierra Nevada, <em>Aluna</em> est l\'origine de toute chose — où tout existe avant de prendre forme.' },
    "man.2": { en:'We take the life you\'ve imagined — the warmth, the calm, the slower mornings — and make it real. <em>Where vision becomes home.</em>',
               es:'Tomamos la vida que imaginaste — la calidez, la calma, las mañanas sin prisa — y la hacemos realidad. <em>Donde la visión se hace hogar.</em>',
               de:'Wir nehmen das Leben, das Sie sich vorgestellt haben — Wärme, Ruhe, langsamere Morgen — und machen es wahr. <em>Wo Vision Zuhause wird.</em>',
               fr:'Nous prenons la vie que vous avez imaginée — la chaleur, le calme, les matins sans hâte — et la rendons réelle. <em>Où la vision devient foyer.</em>' },
    ...
    "gin.body": { en:'Ginebra is an official <em class="gold">Pueblo Mágico</em> northeast of Cali — colonial haciendas, Isabella vineyards and ecosystems from lowland to páramo, all in one town. The cultural and musical heart of the Valle.',
                 es:'Ginebra es un <em class="gold">Pueblo Mágico</em> oficial al noreste de Cali — haciendas coloniales, viñedos de uva Isabella y ecosistemas del trópico al páramo, todo en un pueblo. El corazón cultural y musical del Valle.',
                 de:'Ginebra ist ein offizieller <em class="gold">Pueblo Mágico</em> nordöstlich von Cali — koloniale Haciendas, Isabella-Weinberge und Ökosysteme vom Tiefland bis zum Páramo, alles in einer Stadt. Das kulturelle und musikalische Herz des Tals.',
                 fr:'Ginebra est un <em class="gold">Pueblo Mágico</em> officiel au nord-est de Cali — haciendas coloniales, vignobles Isabella et écosystèmes des basses terres au páramo, le tout dans une seule ville. Le cœur culturel et musical de la Vallée.' },
    ...
    "gin.a5.p": { en:"A city of 2.2 million — hospitals, universities, an international airport — sits under an hour away. Country peace, city access.", es:"Una ciudad de 2,2 millones — hospitales, universidades, aeropuerto internacional — a menos de una hora. Paz del campo, acceso a la ciudad.", de:"Eine Stadt mit 2,2 Millionen — Krankenhäuser, Universitäten, internationaler Flughafen — unter einer Stunde entfernt. Landruhe, Stadtzugang.", fr:"Une ville de 2,2 millions — hôpitaux, universités, aéroport international — à moins d'une heure. Le calme de la campagne, l'accès à la ville." },
    ...
    "prop.desc": { en:"A century-old country home, tastefully remodeled — six bedrooms and shaded corridors among pastures and fruit trees. At 1,136 m, near 24°C all year.", es:"Una casa campestre centenaria, remodelada con buen gusto — seis alcobas y corredores con sombra entre potreros y frutales. A 1.136 m, cerca de 24°C todo el año.", de:"Ein hundertjähriges Landhaus, geschmackvoll renoviert — sechs Schlafzimmer und schattige Korridore zwischen Weiden und Obstbäumen. Auf 1.136 m, das ganze Jahr nahe 24°C.", fr:"Une maison de campagne centenaire, rénovée avec goût — six chambres et des corridors ombragés parmi pâturages et arbres fruitiers. À 1 136 m, près de 24°C toute l'année." },
    ...
    "faq.a2": { en:"Not to begin. The international community is growing and essential services increasingly speak English. Learning Spanish here comes naturally over time.", es:"No para empezar. La comunidad internacional crece y los servicios esenciales hablan cada vez más inglés. Aprender español aquí se vuelve natural con el tiempo.", de:"Nicht für den Anfang. Die internationale Gemeinschaft wächst und wichtige Dienste sprechen zunehmend Englisch. Spanisch zu lernen wird hier mit der Zeit natürlich.", fr:"Pas pour commencer. La communauté internationale grandit et les services essentiels parlent de plus en plus anglais. Apprendre l'espagnol vient naturellement avec le temps." },
    ...
    "faq.a3": { en:"A comfortable month — food, utilities, transport, healthcare and leisure — typically runs $1,500–2,000 USD, several times less than Florida or Germany.", es:"Un mes cómodo — comida, servicios, transporte, salud y ocio — suele costar $1.500–2.000 USD, varias veces menos que en Florida o Alemania.", de:"Ein komfortabler Monat — Essen, Nebenkosten, Transport, Gesundheit und Freizeit — kostet meist 1.500–2.000 USD, ein Mehrfaches weniger als Florida oder Deutschland.", fr:"Un mois confortable — nourriture, charges, transport, santé et loisirs — coûte généralement 1 500–2 000 USD, plusieurs fois moins qu'en Floride ou en Allemagne." },
    ...
    "faq.a4": { en:"Metropolitan Cali, over 2 million people, sits under an hour away — major hospitals, clinics, universities and shopping. Country peace; the city handles the rest.", es:"El área metropolitana de Cali, más de 2 millones, está a menos de una hora — grandes hospitales, clínicas, universidades y compras. Paz del campo; la ciudad hace el resto.", de:"Der Großraum Cali, über 2 Millionen, liegt unter einer Stunde entfernt — große Krankenhäuser, Kliniken, Universitäten und Einkauf. Landruhe; die Stadt erledigt den Rest.", fr:"L'agglomération de Cali, plus de 2 millions, est à moins d'une heure — grands hôpitaux, cliniques, universités et commerces. Le calme; la ville fait le reste." },
    ...
    "foot.copy": { en:"© 2026 Aluna Luxe · Finca San Antonio", es:"© 2026 Aluna Luxe · Finca San Antonio", de:"© 2026 Aluna Luxe · Finca San Antonio", fr:"© 2026 Aluna Luxe · Finca San Antonio" },
    "foot.tag": { en:"Where vision becomes home", es:"Donde la visión se hace hogar", de:"Wo Vision Zuhause wird", fr:"Où la vision devient foyer" },
    "foot.tagline": { en:"Where vision becomes home.", es:"Donde la visión se hace hogar.", de:"Wo Vision Zuhause wird.", fr:"Où la vision devient foyer." }
  };
